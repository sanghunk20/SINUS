...
recipe is visible from the repository root rather than from a directory listing:
    ...
    main_cache.py    cache_dental, cache_teeth
    main_train.py    toothfairy.training.stage_a, toothfairy.training.trainer
    main_rft.py      rft_rollout, rft_filter_cache, rft_rescore, rft_finetune, rft_merge
    main_rewrite.py  rewrite_pairs, rewrite_pairs_from_run, rewrite_train, rewrite_apply
    main_eval.py     generate, captioning, final_score
